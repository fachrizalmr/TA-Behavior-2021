...
if ($behavior == 1) {
    $hasil = mysqli_query($connect, "select * from tbposttugas where idlampu = 1 order by id desc LIMIT 1");
} else {
    $hasil = mysqli_query($connect, "select * from tbdataset where idlampu = 1 order by id desc LIMIT 1");
}
